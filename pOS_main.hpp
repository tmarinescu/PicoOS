...
/* Memory manager */
#define MEMORY_POOL				256			/* Bytes */
#define MEMORY_META_POOL		128			/* Maximum number of allocated objects */

/* Used for task demos */
#define MEM_ID_LED_STATE		0xAABBCCDD	/* ID of your memory ID, can be whatever */
...
#define MEM_ID_DISPLAY_BUFFER	0xDDDDDDDD
#define MEM_ID_BLUETOOTH_INIT	0xEEEEEEEE


/* ======= USED FOR CUSTOM DEMO PROJECT, PLEASE DISABLE USE_CUSTOM_PROJECT_DEMO ======= */
